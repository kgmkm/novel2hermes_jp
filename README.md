...
ただB更新を検知してAを更新する機能はありません(今のところ。これ追加するとトークンコスト・回答時間が嵩みます)。
...
また執筆中に小説から微妙な臭いを感じたら、それはLLMが悪いというより、プロット・設定・企画を疑った方がいいです。いやLLMも超激安みたいな奴とか選ばないでね……。小説書いてもらってる途中でもガンガンプロット直して、その旨を伝え、新プロットや設定にそった形にリライティングしてもらいましょう。脚本はリライトの繰り返しで強くなるって言ってた。
