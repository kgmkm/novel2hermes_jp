...
執筆を始める前に、**正規原典（.md ファイル）と vecmemori の両方**から設定を再構築します。.md ファイルが正規原典であるため、最初に読み込みます。
...
1. proposal.md、character/配下の全ファイル、plot/配下の全ファイルを**すべて読み込んだ状態**で起動
2. 指定された章（または続き）から執筆開始
3. 各シーンは **plot/ファイルの指示に忠実に**、**character/ファイルの設定に忠実に**描写
